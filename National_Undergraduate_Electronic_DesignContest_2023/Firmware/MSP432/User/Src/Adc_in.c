...
void Bp_Fs_Change_F(uint32_t Freq) {
...
uint32_t Bp_Fs_Adjust(uint32_t FL, uint32_t FH)
{
	uint32_t N, BW;
	float K,FS;
	BW = FH - FL;
	...
	uint32_t Signal_Fs_ARR = TIMER_SOURCE_FREQ / FS;
